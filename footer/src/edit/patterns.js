							...
							[
								...
								[
									[
										"core/image",
										{
											url: `${cthfAssets.img}footer-pro-11-1.png`,
											width: "16px",
											sizeSlug: "full",
											linkDestination: "none",
										},
					...
					[
						...
						[
							...
							[
								"core/image",
								{
									url: `${cthfAssets.img}footer-pro-11-2.png`,
									sizeSlug: "full",
									linkDestination: "none",
									style: {
...
export const proFooterPattern16 = [
	[
		"core/cover",
		{
			url: `${cthfAssets.img}footer-pro-16-1.png`,
			dimRatio: 50,
									...
									[
										...
										[
											[
												"core/image",
												{
													url: `${cthfAssets.img}footer-pro-17-1.png`,
													width: "26px",
													sizeSlug: "full",
													linkDestination: "none",
									...
									[
										...
										[
											[
												"core/image",
												{
													url: `${cthfAssets.img}footer-pro-17-2.png`,
													width: "26px",
													sizeSlug: "full",
													linkDestination: "none",
													style: { spacing: { margin: { top: "2px" } } },
									...
									[
										...
										[
											[
												"core/image",
												{
													url: `${cthfAssets.img}footer-pro-17-3.png`,
													width: "26px",
													sizeSlug: "full",
													linkDestination: "none",
													style: { spacing: { margin: { top: "2px" } } },
...
export const proFooterPattern23 = [
	[
		"core/group",
		{
			style: {
...
export const proFooterPattern24 = [
	[
		"core/group",
		{
			style: {
				...
				[
					[
						"core/columns",
						{
							style: {
								border: {
									bottom: { color: "#040c36", style: "solid", width: "1px" },
								},
								spacing: { padding: { top: "0px", bottom: "36px" } },
							},
						},
						[
							[
...
export const proFooterPattern25 = [
	[
		"core/group",
		{
			style: {
				...
				color: { background: "#fffffe", text: "#888888" },
				elements: { link: { color: { text: "#888888" } } },
				typography: { fontSize: "14px" },
			},
			layout: { type: "constrained", contentSize: "100%" },
		},
		[
			[
				"core/group",
				{
					style: {
						border: {
							bottom: { color: "#040c362b", style: "solid", width: "1px" },
						},
						spacing: {
							padding: {
								right: "26px",
							...
							[
								...
								[
									[
										"core/image",
										{
											url: `${cthfAssets.img}footer-pro-25-1.png`,
											width: "40px",
											sizeSlug: "full",
											linkDestination: "none",
											align: "center",
									...
									[
										"core/heading",
										{
											...
											style: {
												...
												spacing: { margin: { top: "12px", bottom: "6px" } },
											},
										},
									],
									[
										"core/paragraph",
										{ content: "Order above $150", align: "center" },
									],
								],
							],
							[
								...
								[
									[
										"core/image",
										{
											url: `${cthfAssets.img}footer-pro-25-2.png`,
											width: "40px",
											sizeSlug: "full",
											linkDestination: "none",
											align: "center",
									...
									[
										"core/paragraph",
										{ content: "Phone & Email Supports", align: "center" },
									],
								],
							],
							[
								...
								[
									[
										"core/image",
										{
											url: `${cthfAssets.img}footer-pro-25-3.png`,
											width: "40px",
											sizeSlug: "full",
											linkDestination: "none",
											align: "center",
									...
									[
										"core/paragraph",
										{ content: "Secured by Stripe", align: "center" },
									],
								],
							],
							[
								...
								[
									[
										"core/image",
										{
											url: `${cthfAssets.img}footer-pro-25-4.png`,
											width: "40px",
											sizeSlug: "full",
											linkDestination: "none",
											align: "center",
									...
									[
										"core/paragraph",
										{ content: "30 day Guareentee", align: "center" },
									],
								],
							],
						],
				...
				[
							...
							[
								...
								[
									...
									[
										"core/paragraph",
										{
											content: `<a href="#">Store Locations</a>`,
											style: {
												spacing: { margin: { top: "0px", bottom: "16px" } },
											},
										},
									...
									[
										"core/paragraph",
										{
											content: `<a href="#">Customer Services</a>`,
											style: {
												spacing: { margin: { top: "0px", bottom: "16px" } },
											},
										},
							...
							[
								...
								[
									...
									[
										"core/paragraph",
										{
											content: `<a href="#">Returns & Exchanges</a>`,
											style: {
												spacing: { margin: { top: "0px", bottom: "16px" } },
											},
										},
									...
									[
										"core/paragraph",
										{
											content: `<a href="#">Delivery Terms</a>`,
											style: {
												spacing: { margin: { top: "0px", bottom: "0px" } },
											},
										},
					...
					[
						"core/group",
						{
							style: {
								border: {
									top: { color: "#040c362b", style: "solid", width: "1px" },
									bottom: { color: "#040c362b", style: "solid", width: "1px" },
								},
								spacing: {
									blockGap: "36px",
...
export const proFooterPattern26 = [
	[
		"core/group",
		{
			style: {
				spacing: {
					padding: { right: "26px", left: "26px", top: "40px", bottom: "20px" },
					margin: { top: "0", bottom: "0" },
				},
				color: { background: "#fffffe", text: "#434343" },
				elements: { link: { color: { text: "#434343" } } },
		...
		[
				...
				[
									...
									[
										...
										[
											[
												"core/image",
												{
													url: `${cthfAssets.img}footer-pro-26-1.png`,
													width: "54px",
													sizeSlug: "full",
													linkDestination: "none",
												},
											...
											[
												"core/paragraph",
												{
													content: `<strong>+1(000)-123456</strong>`,
													style: {
														typography: { fontSize: "18px", lineHeight: "1.3" },
													},
												},
											],
										],
									...
									[
										...
										[
											[
												"core/image",
												{
													url: `${cthfAssets.img}footer-pro-26-2.png`,
													width: "54px",
													sizeSlug: "full",
													linkDestination: "none",
												},
											...
											[
												"core/paragraph",
												{
													content: `<strong>sample@example.com</strong>`,
													style: {
														typography: { fontSize: "18px", lineHeight: "1.3" },
													},
												},
					...
					[
						"core/column",
						{
							...
							style: {
								color: { text: "#170122" },
								elements: { link: { color: { text: "#170122" } } },
								typography: {
									fontSize: "16px",
									fontStyle: "normal",
									lineHeight: "1.2",
					...
					[
						...
						[
							...
							[
								"core/paragraph",
								{
									content: `<a href="#">Web Development</a>`,
									style: {
										spacing: { margin: { top: "0px", bottom: "16px" } },
									},
								},
			...
			[
				"core/group",
				{
					style: {
						border: {
							top: { color: "#1601211f", style: "solid", width: "1px" },
							bottom: { color: "#1601211a", style: "solid", width: "1px" },
						},
						spacing: {
							padding: { top: "26px", bottom: "26px" },
							margin: { top: "60px" },
				...
				[
					...
					[
						"core/social-links",
						{
							...
							iconBackgroundColorValue: "#fffffe00",
							className: "cthf__pro-footer-24",
							style: { spacing: { blockGap: { top: "12px", left: "12px" } } },
						},
						[
							["core/social-link", { url: "#", service: "facebook" }],
							["core/social-link", { url: "#", service: "x" }],
...
export const proFooterPattern27 = [
	[
		"core/group",
		{
			style: {
				spacing: {
					padding: { right: "26px", left: "26px", top: "40px", bottom: "0px" },
					margin: { top: "0", bottom: "0" },
				},
				color: { background: "#f4f5ff", text: "#434343" },
				elements: { link: { color: { text: "#434343" } } },
				typography: { fontSize: "14px" },
			},
			layout: { type: "constrained", contentSize: "1180px" },
								...
								[
									[
										"core/heading",
										{
											...
											style: {
												color: { text: "#040b2e" },
												elements: { link: { color: { text: "#040b2e" } } },
												typography: {
													fontSize: "16px",
													fontStyle: "normal",
													fontWeight: "600",
			...
			[
				"core/group",
				{
					style: {
						...
						border: { top: { color: "#040b2e1c", width: "1px" } },
					},
					layout: {
						type: "flex",
						flexWrap: "wrap",
				...
				[
					...
					[
						"core/paragraph",
						{
							content: `<a href="#">Privacy Policy</a>  |  <a href="#">Terms &amp; Conditions</a>`,
						},
					],
				],
			],
...
export const proFooterPattern28 = [
	[
		"core/group",
		{
			style: {
				...
				color: { background: "#283593", text: "#e9e8e8" },
			...
			[
				...
				[
							...
							[
								...
								[
									...
									[
										"core/paragraph",
										{
											content: `<a href="#">Digital Marketing</a>`,
											style: {
												spacing: { margin: { top: "26px", bottom: "16px" } },
											},
										},
									...
									[
										"core/paragraph",
										{
											content: `<a href="#">Product Design</a>`,
											style: {
												spacing: { margin: { top: "0px", bottom: "16px" } },
											},
										},
					...
					[
						"core/group",
						{
							style: { spacing: { margin: { top: "60px", bottom: "44px" } } },
							layout: {
								type: "flex",
								flexWrap: "wrap",
								justifyContent: "space-between",
...
export const proFooterPattern29 = [
	[
		"core/group",
		{
			style: {
			...
			[
				...
				[
					...
					[
						"core/paragraph",
						{
							content: `Proudly powered by WordPress | Theme by <mark style="background-color:rgba(0, 0, 0, 0);color:#f4f4f4" class="has-inline-color">CozyThemes`,
							align: "center",
							style: { spacing: { margin: { top: "26px", bottom: "16px" } } },
						},
					],
					[
						"core/social-links",
						{
							...
							customIconBackgroundColor: "#fffffe00",
							iconBackgroundColorValue: "#fffffe00",
							style: { spacing: { blockGap: { top: "10px", left: "0" } } },
							layout: { type: "flex", justifyContent: "center" },
						},
						[
							["core/social-link", { url: "#", service: "facebook" }],
...
export const proFooterPattern30 = [
	[
		"core/group",
		{
			style: {
					...
					[
						...
						[
							...
							[
								"core/paragraph",
								{
									content: `<a href="#">404 Not Found</a>`,
									style: {
										spacing: { margin: { top: "0px", bottom: "16px" } },
									},
								},
					...
					[
						"core/column",
						{
							...
							style: {
								...
								border: { radius: "20px" },
								color: { background: "#001cb2", text: "#fffffe" },
								elements: { link: { color: { text: "#fffffe" } } },
							},
							layout: { type: "constrained", contentSize: "369px" },
						},
						[
							[
								"core/heading",
							...
							[
								"core/paragraph",
								{
									content: `Add 'Contact form 7' shortcode or equivalent.`,
									style: {
										spacing: { margin: { top: "26px", bottom: "0px" } },
									},
								},
			...
			[
				"core/group",
				{
					style: {
						...
						border: {
							top: { color: "#040b2e17", style: "solid", width: "1px" },
						},
						elements: { link: { color: { text: "#434343" } } },
						color: { text: "#434343" },
					},
...
export const proFooterPattern31 = [
	[
		"core/group",
		{
			style: {
				...
				color: { background: "#1f3295", text: "#f2f2f2" },
				elements: { link: { color: { text: "#f2f2f2" } } },
				typography: { fontSize: "14px" },
			},
			layout: { type: "constrained", contentSize: "1180px" },
					...
					[
						...
						[
							...
							[
								"core/paragraph",
								{
									content: `<strong>Monday to Friday</strong>`,
									style: {
										spacing: { margin: { top: "26px", bottom: "0px" } },
										typography: { fontSize: "16px" },
									},
							...
							[
								"core/paragraph",
								{
									content: `<strong>Saturday to Sunday</strong>`,
									style: {
										spacing: { margin: { top: "0px", bottom: "0px" } },
										typography: { fontSize: "16px" },
									},
...
export const proFooterPattern32 = [
	[
		"core/group",
		{
			style: {
				spacing: {
					padding: { right: "26px", left: "26px", top: "80px", bottom: "40px" },
					margin: { top: "0", bottom: "0" },
				},
				color: {
					gradient:
						"linear-gradient(135deg,rgb(215,220,250) 0%,rgb(237,206,254) 100%)",
					text: "#434343",
				},
				elements: { link: { color: { text: "#434343" } } },
				typography: { fontSize: "14px" },
...
export const proFooterPattern33 = [
	[
		"core/group",
		{
			style: {
							...
							[
								...
								[
									...
									[
										...
										{},
										[["core/paragraph", { content: "No posts found!" }]],
									],
								],
							],
						],
					...
					[
						...
						[
							...
							[
								...
								{
									linkTo: "none",
									style: { spacing: { blockGap: { top: "4px", left: "4px" } } },
								},
								[
									[
										"core/image",
...
export const proFooterPattern38 = [
	[
		"core/group",
		{
			style: {
				color: { background: "#13151f", text: "#f2f2f2" },
				elements: { link: { color: { text: "#f2f2f2" } } },
				spacing: {
					padding: { right: "26px", left: "26px", top: "80px", bottom: "0px" },
					margin: { top: "0", bottom: "0" },
...
export const proFooterPattern39 = [
	[
		"core/group",
		{
			style: {
					...
					[
						...
						[
							...
							[
								"core/paragraph",
								{
									content: `<a href="#">Sustainability</a>`,
									style: {
										spacing: { margin: { top: "0px", bottom: "0px" } },
									},
								},
...
export const proFooterPattern40 = [
	[
		"core/group",
		{
			style: {
		...
		[
			[
				"core/columns",
				{ style: { spacing: { blockGap: { top: "44px", left: "36px" } } } },
				[
					[
						"core/column",
						{
							...
							[
								...
								[
									[
										"core/image",
										{
											url: `${cthfAssets.img}footer-pro-40-1.png`,
											sizeSlug: "full",
											linkDestination: "none",
										},
									],
							...
							[
								...
								[
									[
										"core/image",
										{
											url: `${cthfAssets.img}footer-pro-40-2.png`,
											sizeSlug: "full",
											linkDestination: "none",
										},
									],
							...
							[
								...
								[
									[
										"core/image",
										{
											url: `${cthfAssets.img}footer-pro-40-3.png`,
											sizeSlug: "full",
											linkDestination: "none",
										},
									],
			...
			[
				...
				[
					[
						"core/paragraph",
						{
							content: `Proudly powered by WordPress | Theme by <mark style="background-color:rgba(0, 0, 0, 0);color:#3450e6" class="has-inline-color">CozyThemes</mark>`,
						},
					],
					[
						"core/social-links",
...
export const proFooterPattern41 = [
	[
		"core/group",
		{
			style: {
				color: { background: "#f3f5ff", text: "#434343" },
				spacing: {
				...
				"core/group",
				{
					style: {
						spacing: {
							...
							margin: { top: "0", bottom: "60px" },
						},
						border: {
							bottom: { color: "#040c3621", style: "solid", width: "1px" },
						},
					},
					layout: { type: "constrained", contentSize: "1180px" },
				},
							...
							[
								...
								[
									[
										"core/paragraph",
										{
											content: "Add a 'Contact Form 7' shortcode or equivalent",
										},
									],
									["core/shortcode"],
								],
				...
				[
					...
					[
						"core/group",
						{
							style: {
								border: {
									top: { color: "#040c3621", style: "solid", width: "1px" },
								},
								spacing: {
									padding: {
										right: "0px",
...
export const proFooterPattern42 = [
	[
		"core/group",
		{
			style: {
				color: { text: "#434343", background: "#fffffe" },
				spacing: {
					padding: { right: "0px", left: "0px", top: "0px", bottom: "0px" },
					margin: { top: "0px", bottom: "0px" },
					blockGap: "0",
...
export const proFooterPattern43 = [
	[
		"core/group",
		{
			style: {
				color: { background: "#fffffe", text: "#4b4b4b" },
				spacing: {
					padding: { right: "0px", left: "0px", top: "0px", bottom: "0px" },
					margin: { top: "0px", bottom: "0px" },
					blockGap: "0",
					...
					[
						...
						[
							...
							[
								"core/social-links",
								{
									customIconColor: "#3450e6",
									iconColorValue: "#3450e6",
									customIconBackgroundColor: "#fffffe00",
									iconBackgroundColorValue: "#fffffe00",
									size: "has-normal-icon-size",
									style: {
...
export const proFooterPattern44 = [
	[
		"core/group",
		{
			style: {
		...
		[
									...
									[
										...
										[
											[
												...
												{
													content:
														"Please add 'Contact Form 7' shortcode or equivalent.",
												},
											],
											["core/shortcode"],
										],
			...
			[
				"core/group",
				{
					style: {
						border: {
							top: { color: "#ffffff29", style: "solid", width: "1px" },
							right: {},
							bottom: {},
							left: {},
						},
...
export const proFooterPattern45 = [
	[
		"core/group",
		{
			style: {
				color: { background: "#f2e7f8", text: "#434343" },
				spacing: {
					padding: { right: "0px", left: "0px", top: "0px", bottom: "0px" },
					margin: { top: "0px", bottom: "0px" },
					blockGap: "0",
		...
		[
			...
			[
				"core/group",
				{
					style: {
						border: {
							top: { color: "#27272729", style: "solid", width: "1px" },
							right: {},
							bottom: {},
							left: {},
						},
...
export const proFooterPattern46 = [
	[
		"core/group",
		{
			style: {
			...
			[
				...
				[
					[
						"core/heading",
						{
							content: "Ready to Build Success Together!",
							level: 3,
							style: {
								elements: { link: { color: { text: "#fffffe" } } },
								color: { text: "#fffffe" },
					...
					[
						...
						[
							...
							[
								"core/paragraph",
								{
									content: "2345 Beach,Rd Metrocity USA, HWY 1235",
									style: {
										spacing: { margin: { top: "26px", bottom: "16px" } },
									},
								},
			...
			[
				"core/group",
				{
					style: {
						...
						color: { text: "#d9d9d9" },
						border: {
							top: { color: "#ae0dff42", style: "solid", width: "1px" },
							right: {},
							bottom: {},
							left: {},
						},
