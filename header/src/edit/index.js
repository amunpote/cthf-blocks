					...
					(deviceType === "Tablet" || deviceType === "Mobile") && (
						<>
							<div className={`cthf__mobile-layout-wrapper element-${blockID}`}>
													...
													{layout.map((item) => {
														switch (item) {
															...
															case "Navigation":
																...
																if (
																	attributes.navigation.icon === "variation-2"
																) {
																	path =
								...
								{/* {openSidebar && (
									<>
										<div className="cthf__sidebar-panel-wrap">
											<div className="sidebar-panel__overlay" />

											<div
												className={`sidebar-panel__body position-${attributes.sidebar.position} content-align-${attributes.sidebar.contentAlign}`}
											>
												<svg
													class="close__icon"
													width="10"
